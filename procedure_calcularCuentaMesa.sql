...
DELIMITER $$
USE `restaurant`$$
CREATE PROCEDURE `calcularCuentaDeMesa`( numMesa INT )
BEGIN  
	...
	NATURAL JOIN ItemCartaGeneral  NATURAL JOIN PrecioItemCartaGeneral WHERE fechaYHoraInicioServicio = '2018-11-30 10:32:00' AND mesa = numMesa UNION
	...
	NATURAL JOIN Capacidad WHERE fechaYHoraInicioServicio = '2018-11-30 10:32:00' AND mesa = numMesa UNION
	...
	NATURAL JOIN ItemMenuPromocional NATURAL JOIN Pasos WHERE fechaYHoraInicioServicio = '2018-11-30 10:32:00' AND mesa = numMesa) 
